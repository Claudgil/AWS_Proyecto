...
if __name__ == "__main__":
    ...
    input_path = os.path.abspath("C:/Users/pavil/OneDrive/Documentos/Trabajo_Remoto/Morris&Opazo/AWS_ReStart/AWSproyecto.css/dataset/ventas.csv")
    output_csv_path = os.path.abspath("C:/Users/pavil/OneDrive/Documentos/Trabajo_Remoto/Morris&Opazo/AWS_ReStart/AWSproyecto.css/dataset/ventas_lmpias.csv")
    output_excel_path = os.path.abspath("C:/Users/pavil/OneDrive/Documentos/Trabajo_Remoto/Morris&Opazo/AWS_ReStart/AWSproyecto.css/dataset/ventas_lmpias.xlsx")
